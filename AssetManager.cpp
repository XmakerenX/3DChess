...
// Name : readFBXNormal
//-----------------------------------------------------------------------------
glm::vec3 AssetManager::readFBXNormal(FbxMesh* mesh, int controlPointIndex, int vertexCounter )
{
...
// Name : readFBXUV
//-----------------------------------------------------------------------------
glm::vec2 AssetManager::readFBXUV(FbxMesh* mesh, int controlPointIndex, int j, int k)
{
    FbxVector2 uv;
